...
export const SPOTLIGHT_COPY = {
  ...
  subtitle:
    "Создайте презентацию из текста или загруженных материалов: нейросеть соберёт готовую презентацию с интересным текстом, логичной структурой и трендовым дизайном в PPTX.",
} as const;
...
export const BENEFIT_CARDS: BenefitCardItem[] = [
  {
    ...
    description:
      "От 20 ₽ за презентацию вместо тысяч ₽ за каждую работу на бирже — без ожидания и правок.",
...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Напишите в поддержку support@presentsimple.ai с почты аккаунта и укажите причину — рассмотрим обращение по политике возвратов.",
  },
  {
...
export const AUDIENCE_CARDS: AudienceCard[] = [
  ...
  },
  {
    ...
    lead: "Когда нужно провести клиента от первого интереса до сделки.",
...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Премиальные текстовые ИИ-модели",
    ],
  },
  {
    name: "Бизнес",
