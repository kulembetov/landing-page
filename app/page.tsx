...
import { FAQ_ITEMS, PROCESS_STEPS } from "@/lib/landing-content";
...
export default function HomePage() {
  ...
  const howToJsonLd = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "Как создать презентацию с помощью нейросети",
    description:
      "Пошаговая инструкция: как сделать презентацию PowerPoint с помощью нейросети presentsimple — от темы или загруженных материалов до готового файла PPTX.",
    totalTime: "PT3M",
    inLanguage: "ru",
    tool: {
      "@type": "HowToTool",
  ...
  return (
    <>
      ...
      <script type="application/ld+json">{serializeJsonLd(howToJsonLd)}</script>
