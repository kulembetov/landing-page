...
export function Hero() {
  return (
    <section
      ...
      data-metrika-scroll-goals="reach_block1"
    >
      <div className="hero-inner">
        ...
        <FadeUp mount delay={0.3} className="hero-actions">
          <CtaButton href={APP_CTA_HREF} data-metrika-goal="start_main_block">
            {CTA_LABELS.primary}
          </CtaButton>
          <CtaButton href="#howit" variant="ghost" data-metrika-goal="how_it_works">
            <PlayCircleIcon />
